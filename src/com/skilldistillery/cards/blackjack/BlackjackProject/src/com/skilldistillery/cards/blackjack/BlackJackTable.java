...
public class BlackJackTable {
	...
	public void welcome() {
		System.out.println(" " + '\u2660' + " " + '\u2667' + " " + '\u2666' + " " + '\u2661' + " " + '\u2664' + " "
				...
				+ '\u2664' + " " + '\u2663' + " " + '\u2662' + " " + '\u2665');
		System.out.println('\u2660' + " " + '\u2667' + " " + '\u2666' + " " + '\u2661' + " "
				+ "    Welcome to the Beau Rivage BlackJack Table     " + " " + '\u2664' + " " + '\u2663' + " "
				+ '\u2662' + " " + '\u2665');
		System.out.println(" " + '\u2660' + " " + '\u2667' + " " + '\u2666' + " " + '\u2661' + " " + '\u2664' + " "
				+ '\u2663' + " " + '\u2662' + " " + '\u2665' + " " + '\u2664' + " " + '\u2663' + " " + '\u2662' + " "
				+ '\u2665' + " " + '\u2660' + " " + '\u2667' + " " + '\u2666' + " " + '\u2661' + " " + '\u2666' + " "
	...
	public void deal() {
		...
		System.out.println("\nShall I deal you in? press 1 for yes / or 2 to quit\n");
...
//			if (deck.checkDeckSize() <= 20)    -- not sure why this doesn't work, it does for ==52 only
			deck.shuffleCard(); // not working idky - it did and does in the deck class
